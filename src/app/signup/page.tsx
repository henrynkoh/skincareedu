...
export const metadata = {
  title: 'Sign Up - SkincareEdu',
  description: 'Create your SkincareEdu account',
};
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  name="agreeTerms"
                  type="checkbox"
                  className={`focus:ring-primary h-4 w-4 text-primary border-gray-300 rounded ${errors.agreeTerms ? 'border-red-300' : ''}`}
